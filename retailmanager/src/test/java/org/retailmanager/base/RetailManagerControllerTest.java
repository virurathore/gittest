...
public class RetailManagerControllerTest extends BaseControllerTest {
    ...
    public void testGetShops() throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.get(uri)
        		.param("customerLongitude", "432")
        		.param("customerLatitude", "941")
    ...
    public void testGetShopsNotFound() throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.get(uri)
        		.param("customerLongitude", Long.toString(lng))
        		.param("customerLatitude", Long.toString(ltd))
                .accept(MediaType.APPLICATION_JSON)).andReturn();
    ...
    public void testCreateShops() throws Exception {
        ...
        String inputJson = super.mapToJson(shopRequestVO);
        ...
        Assert.assertNotNull("failure - expected shops not null",
        		shopsResponseVO);
        Assert.assertEquals("failure - expected shopname match", "testShop111",
        		shopsResponseVO.getShopsName());
